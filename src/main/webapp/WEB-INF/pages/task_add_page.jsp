...
<div class="container">
    <form role="form" class="form-horizontal" action="/contact/add" method="post">
        ...
        <input class="form-control form-group" type="text" name="surname" placeholder="Фамилия">
        <input class="form-control form-group" type="text" name="description" placeholder="текст">
        <input class="form-control form-group" type="text" name="date" placeholder="ГГГГ-ММ-ДД ЧЧ:ММ">
